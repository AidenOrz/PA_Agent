...
from pa_agent.config.paths import TRADE_RECORDS_DIR, sanitize_filename_component
from pa_agent.util.price_tick import infer_price_tick_from_frame

_TRADE_RECORDS_DIR = TRADE_RECORDS_DIR
_TRADE_RECORDS_LOCK = threading.RLock()
...
def load_last_trade_csv_row(symbol: str, timeframe: str) -> dict[str, str] | None:
    ...
    safe_tf = sanitize_filename_component(timeframe)
