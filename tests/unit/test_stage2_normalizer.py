...
def test_normalize_stage2_preserves_illegal_no_order_price_for_validation() -> None:
    payload = {
        "decision": {
            "order_type": "不下单",
            "order_direction": None,
        ...
        "decision_trace": [],
        "terminal": {"node_id": "10.3", "outcome": "wait", "label": "wait"},
    }

    normalized = normalize_stage2(payload)
    assert normalized["decision"]["entry_price"] == 123.45
